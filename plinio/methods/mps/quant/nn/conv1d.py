...
class QuantConv1d(nn.Conv1d, QuantModule):
    """A nn.Module implementing a quantized Conv1d layer
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        """The forward function of linear conv1d layer.
    ...
    def export(n: fx.Node,
               ...
               backend: Backend,
               backend_kwargs: Dict = {}):
        """Replaces a fx.Node corresponding to a Quant_Conv1d layer,
