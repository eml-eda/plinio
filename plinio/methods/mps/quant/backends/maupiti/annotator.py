...
class MAUPITIAnnotator:
    """Class to annotate MAUPITI-compliant onnx model"""
    ...
    def _annotate(self,
        ...
        for n in onnxproto.graph.node:
            ...
            if op_type in maupiti_onnxnode_op_types['linear']:
            ...
            elif op_type in maupiti_onnxnode_op_types['clip']:
